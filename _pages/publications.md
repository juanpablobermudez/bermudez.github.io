...
## Temptation and Apathy (preprint) 
...
## The whole is larger than the sum of its parts: additive effects of SMS nudge bundles (.pdf)
With S. Barbosa
...
➤  See also our op-ed on the topic at Euractiv
...
## Efforts and their Feelings (preprint)
With Olivier Massin
...
## Will-powered: Synchronic regulation is the difference maker for self-control (preprint)  (final [paywalled])
...
## What’s inside is all that counts? The contours of everyday thinking about self-control (preprint)
...
## Intentional mind-wandering as intentional omission: The surrealist method (.pdf)
...
## Willpower needs tactical skill (preprint) (final [paywalled])
...
## Do we reflect while performing skillful actions? (preprint) (final)
...
See a video presentation of the paper here.

## Is a bad will a weak will? Cognitive dispositions modulate folk attributions of weakness of will
With Alejandro Rosas & Antonio Gutiérrez (preprint) (final)
...
## Social media and self-control (preprint)
